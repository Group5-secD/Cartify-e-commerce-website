...
// ========== PRODUCT CONSTRUCTOR (Chapter 4: Constructor Functions) ==========
...
// ========== USER CONSTRUCTOR (Chapter 4: Object-Oriented Design) ==========
...
function Order(cartItems, userInfo) {
  ...
  this.userInfo = Object.assign({}, userInfo); // Object.assign()
...
// ========== MOCK PRODUCT DATA (Hardcoded as per requirements) ==========
var products = [
...
// ========== NAVIGATION FUNCTIONS (Function Expressions & Closures) ==========
